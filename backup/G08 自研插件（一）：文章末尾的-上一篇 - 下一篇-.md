...
不用翻别的文章，**你现在滚到这篇文章评论按钮的上方**，就能看到两块卡片：左边通向上一篇 [G07 写作三件套](/post/13.html)，右边是一块灰色的"已经到尽头啦"——因为本文发布时它就是最新的一篇。这个导航在全站每篇文章底部都有，颜色自动跟随明暗主题，手机上会竖起来排列。
...
主题切换靠 `<html data-color-mode="dark">` 钩子，Primer 内部接管变量，插件连"监听主题按钮"都省了——对比 G07 的 mermaid 必须手动监听重绘，CSS 变量方案是真·躺赢。其余细节：标题超长两行省略、hover 上浮 1px、600px 以下纵向堆叠。
...
(function () {
    ...
    function injectStyle() {
        ...
        style.textContent =
          ...
          + 'padding:12px 14px;border:1px solid var(--color-border-muted,#d0d7de);'
          ...
          + '.gmeek-pn-label,.gmeek-pn-date{font-size:12px;color:var(--color-fg-muted,#656d76);}'
          + '.gmeek-pn-title{font-weight:600;line-height:1.4;display:-webkit-box;'
          + '-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;}'
          + '.is-disabled{opacity:.45;pointer-events:none;}'
          + '@media (max-width:600px){.gmeek-pn{flex-direction:column;}'
