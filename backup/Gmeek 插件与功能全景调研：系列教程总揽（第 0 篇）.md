...
| B01 | [18 秒建站实录：从一个 GitHub 账号到第一篇文章上线](/post/32.html) | 零起点动手篇：注册→模板建仓→Pages 开关→建标签发 issue→看绿勾；user/project site 命名规则、三考点、翻车急诊室 | 地基篇 | ✅（4 张登录态截图为占位图待补拍） |
...
| B01 | [18 秒建站实录](/post/32.html) | 注册到首篇带标签文章上线；命名、Pages 开关、标签开关三考点 | ✅（4 张登录态配图待补拍） |
